    ...
    dt = $("#datatable").DataTable({
        ...
        columnDefs: [
            ...
            },
            {
                ...
                render: function (data, type, row) {
                    return `
                        <a href="Streaming/Editar?id=${row.id}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1 btn-acao-editar">
